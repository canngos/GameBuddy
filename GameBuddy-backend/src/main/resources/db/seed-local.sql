...
INSERT INTO games (game_id, game_name, category, description, game_icon, avg_vote, is_popular) VALUES
  ...
  ('d0c0e651-96c6-56de-8951-89d33b90b010', 'Age of Empires II', 'Strategy', 'Age of Empires II - seeded for local development', NULL, 4.0, true),
  ...
  ('374b9676-d53e-53b4-afc5-833e47825c9d', 'Atelier Ryza 3', 'JRPG', 'Atelier Ryza 3 - seeded for local development', NULL, 4.0, true),
  ...
  ('aea289ab-02a3-566e-b5e1-c8639fe92f61', 'Baldur''s Gate 3', 'RPG', 'Baldur''s Gate 3 - seeded for local development', NULL, 4.0, true),
  ('97e85813-54d0-53b5-b087-c30406052858', 'Battlefield 6', 'FPS', 'Battlefield 6 - seeded for local development', NULL, 4.0, true),
  ('9d6d9af4-8949-5307-9f60-96cdb1bcb761', 'Black Desert Online', 'MMO', 'Black Desert Online - seeded for local development', NULL, 4.0, true),
  ...
  ('02194d97-e861-5427-8543-2b7cbe2ee152', 'Civilization VII', 'Strategy', 'Civilization VII - seeded for local development', NULL, 4.0, true),
  ...
  ('5716e40c-d03d-5a9e-92b7-8458f0473c45', 'Doom (1993)', 'FPS', 'Doom (1993) - seeded for local development', NULL, 4.0, false),
  ...
  ('d82daa94-98c1-5876-9507-96dd3e5052e3', 'Final Fantasy XIV', 'MMO', 'Final Fantasy XIV - seeded for local development', NULL, 4.0, false),
  ('1b2521f1-6b03-5035-9861-3ccd0f9d0e45', 'Football Manager 2025', 'Simulation', 'Football Manager 2025 - seeded for local development', NULL, 4.0, false),
  ...
  ('086fd79b-8df1-528c-94c2-bf2f96dcd7b2', 'Minecraft', 'Sandbox', 'Minecraft - seeded for local development', NULL, 4.0, false),
  ...
  ('7958fd20-48e0-5948-9e52-d33887ba225e', 'Overwatch 2', 'FPS', 'Overwatch 2 - seeded for local development', NULL, 4.0, false),
  ...
  ('a69aad1d-e57d-532b-a565-697326911efd', 'REPO', 'Horror', 'REPO - seeded for local development', NULL, 4.0, false),
  ...
  ('03d76daf-8cd1-5047-af88-e1adb81d401c', 'Resident Evil 4 Remake', 'Horror', 'Resident Evil 4 Remake - seeded for local development', NULL, 4.0, false),
  ...
  ('c16d02e7-27e6-5f5b-9a46-623fc41820d4', 'Slay the Spire 2', 'Roguelike', 'Slay the Spire 2 - seeded for local development', NULL, 4.0, false),
  ...
  ('7fef210c-abf7-555c-8020-1e3f12952356', 'StarCraft II', 'Strategy', 'StarCraft II - seeded for local development', NULL, 4.0, false),
...
INSERT INTO cosmetic (id, kind, name, asset_key, animated, price, sort_order) VALUES
  ('948fe89b-b161-5324-8fe3-d54014739e97', 'FRAME', 'Steel', 'frames/frame-steel.png', false, 0, 0),
  ('c65bd3d8-6b59-546a-ac85-8f9bd080b279', 'FRAME', 'Signature', 'frames/frame-brand.png', false, 0, 1),
  ('202e2cb8-5e54-577e-8ea1-2a56d4aa6a5d', 'FRAME', 'Reticle', 'frames/frame-reticle.png', false, 150, 2),
  ('772595df-1b8a-5c40-b18a-fafa83de3297', 'FRAME', 'Bronze', 'frames/frame-bronze.png', false, 200, 3),
  ('7767adda-3c57-5bb8-9c19-66e3668d961c', 'FRAME', 'Gold', 'frames/frame-gold.png', false, 400, 4),
  ('5111d8c6-c0e3-5320-8a22-e06fe89883c1', 'FRAME', 'Pulse', 'frames/frame-pulse.webp', true, 600, 5),
  ('df6369a3-e370-5c22-9fa5-4e51bab9cdec', 'FRAME', 'Sweep', 'frames/frame-sweep.webp', true, 750, 6),
  ('089fed4f-abc2-5193-ac25-5aa437fd52a0', 'FRAME', 'Orbit', 'frames/frame-orbit.webp', true, 900, 7),
  ('0473126d-f42e-5971-8e64-d6e2a26bed08', 'FRAME', 'Toxic', 'frames/frame-toxic.webp', true, 900, 8),
  ('90f6a11b-fa77-561b-9722-6c5b0ee79d09', 'FRAME', 'Rotor', 'frames/frame-rotor.webp', true, 1200, 9),
  ('32fa7c71-9011-59d9-9155-4e5e710e974c', 'FRAME', 'Ember', 'frames/frame-ember.webp', true, 1500, 10),
  ('5c03c249-15e3-5e97-98e7-e2b659e3c444', 'BANNER', 'Hex', 'banners/banner-hex.jpg', false, 0, 0),
  ('c4793a6f-b11f-544e-8fb5-50070bc6e7c3', 'BANNER', 'CRT', 'banners/banner-crt.jpg', false, 0, 1),
  ('40fe7f85-d3e0-5def-942e-4be7d6c36fc3', 'BANNER', 'Bokeh', 'banners/banner-bokeh.jpg', false, 200, 2),
  ('23a03605-0cbe-5abf-80d3-59a1fcea2397', 'BANNER', 'Circuit', 'banners/banner-circuit.jpg', false, 300, 3),
  ('c637135f-3d1c-58b9-84ed-a7d2c3bad9c1', 'BANNER', 'Void', 'banners/banner-void.jpg', false, 400, 4),
  ('a217b933-c1e1-5a13-aa29-e36321cd1cbd', 'BANNER', 'Arena', 'banners/banner-arena.jpg', false, 500, 5),
  ('0fe0e4e0-9c3b-5526-87af-46b192ca596d', 'BANNER', 'Dusk', 'banners/banner-dusk.jpg', false, 600, 6),
  ('10db4e23-1579-5f41-83f9-e4db8f75d93a', 'BANNER', 'Synthwave', 'banners/banner-synthwave.jpg', false, 800, 7)
