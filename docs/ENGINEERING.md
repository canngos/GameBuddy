# GameBuddy — Engineering Notes

The deep end: how the pieces actually behave in the places that bite. This was the bulk of
the old root README, kept intact so nothing was lost when the front page was slimmed down.
For the overview, quick start, and architecture sketch, start at the [root README](../README.md).
